...
public abstract class AbstractPersonMapper
{
     ...
     */
    public abstract ServerPersonEntity fromClientToServer(ClientPersonEntity entity, @Context CycleAvoidingMappingContext context, @Context EntityManager entityManager) throws Exception;
     ...
     * @throws PersonException Thrown to indicate an error occurred while trying to copy a person entity.
     */
    public abstract ClientPersonEntity copy(ClientPersonEntity entity, @Context CycleAvoidingMappingContext context) throws PersonException;
}
